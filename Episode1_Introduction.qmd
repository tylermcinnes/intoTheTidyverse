...
In this workshop we will start out assuming you know nothing about R. We *will* assume that you have R, and RStudio, installed on your computer or that you are using RStudio in a training environment\*. 
...
This workshop places a strong focus on practice and repetition through exercises. You are attempting to learn a language, and you can't do that without practice. Once you have experience with the basics, we will move on
